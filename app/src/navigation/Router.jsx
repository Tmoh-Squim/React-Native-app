    ...
    <>
      ...
      <NavigationContainer>
        <Stack.Navigator
          ...
          <Stack.Screen
            name="user"
            component={isAuthenticated ? UserScreen : Login}
          />
          ...
          <Stack.Screen
            name="delivery"
            component={user?.user ? DeliveryScreen : Login}
          />
          <Stack.Screen
            name="payment"
            component={user?.user ? PaymentScreen : Login}
          />
          <Stack.Screen
            name="login"
            component={user?.user ? HomeScreen : Login}
          />
          <Stack.Screen name="faq" component={FAQ} />
          <Stack.Screen
            name="register-user"
            component={user?.user ? HomeScreen : RegisterUser}
          />
          <Stack.Screen
            name="user-orders"
            component={user?.user ? Orders : Login}
          />
          <Stack.Screen
            name="product-update"
            component={
              user?.user?.role === 'Admin' ? UpdateProduct : HomeScreen
            }
          />
          <Stack.Screen name="Order-details" component={OrderDetails} />
          <Stack.Screen
            name="admin-orders"
            component={user?.user?.role === 'Admin' ? AllOrders : HomeScreen}
          />
          <Stack.Screen
            name="admin-update-order"
            component={user?.user?.role === 'Admin' ? UpdateOrder : HomeScreen}
          />
          <Stack.Screen
            name="admin-update-event"
            component={user?.user?.role === 'Admin' ? EventUpdateScreen : HomeScreen}
          />
          <Stack.Screen
            name="admin-refund-order"
            component={
              user?.user?.role === 'Admin' ? RefundendOrders : HomeScreen
            }
          />
          <Stack.Screen
            name="admin-refund-order-details"
            component={
              user?.user?.role === 'Admin' ? RefundendOrderDetails : HomeScreen
            }
          />
